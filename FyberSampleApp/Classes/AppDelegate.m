...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    OFWVirtualCurrencySettings *vcsStartOptions = [OFWVirtualCurrencySettings virtualCurrencySettingsWithSecurityToken:@"sec_135708" delegate:self];
    [OfferWall startWithAppId:@"135708" delegate:self settings:vcsStartOptions completion:^(OFWError * _Nullable error) {
        if (error) {
